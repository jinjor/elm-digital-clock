...
var _user$project$Clock$f = false;
var _user$project$Clock$t = true;
var _user$project$Clock$D = F7(
	function (a, b, c, d, e, f, g) {
		return {ctor: 'D', _0: a, _1: b, _2: c, _3: d, _4: e, _5: f, _6: g};
	});
var _user$project$Clock$digit = function (n) {
	var _p0 = n;
	switch (_p0) {
		case 0:
			return A7(_user$project$Clock$D, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$f, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$t);
		case 1:
			return A7(_user$project$Clock$D, _user$project$Clock$f, _user$project$Clock$f, _user$project$Clock$t, _user$project$Clock$f, _user$project$Clock$f, _user$project$Clock$t, _user$project$Clock$f);
		case 2:
			return A7(_user$project$Clock$D, _user$project$Clock$t, _user$project$Clock$f, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$f, _user$project$Clock$t);
		case 3:
			return A7(_user$project$Clock$D, _user$project$Clock$t, _user$project$Clock$f, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$f, _user$project$Clock$t, _user$project$Clock$t);
		case 4:
			return A7(_user$project$Clock$D, _user$project$Clock$f, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$f, _user$project$Clock$t, _user$project$Clock$f);
		case 5:
			return A7(_user$project$Clock$D, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$f, _user$project$Clock$t, _user$project$Clock$f, _user$project$Clock$t, _user$project$Clock$t);
		case 6:
			return A7(_user$project$Clock$D, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$f, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$t);
		case 7:
			return A7(_user$project$Clock$D, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$f, _user$project$Clock$f, _user$project$Clock$t, _user$project$Clock$f);
		case 8:
			return A7(_user$project$Clock$D, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$t);
		case 9:
			return A7(_user$project$Clock$D, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$t, _user$project$Clock$f, _user$project$Clock$t, _user$project$Clock$t);
		default:
			return A7(_user$project$Clock$D, _user$project$Clock$f, _user$project$Clock$f, _user$project$Clock$f, _user$project$Clock$f, _user$project$Clock$f, _user$project$Clock$f, _user$project$Clock$f);
	}
};
var _user$project$Clock$digitPair = function (n) {
	var second = A2(_elm_lang$core$Basics_ops['%'], n, 10);
	var first = A2(_elm_lang$core$Basics_ops['%'], (n / 10) | 0, 10);
	return {
		ctor: '_Tuple2',
		_0: _user$project$Clock$digit(first),
		_1: _user$project$Clock$digit(second)
	};
};

var _user$project$Main$viewDigitPart = F2(
	function (cls, on) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('digit-part'),
				_1: {
					ctor: '::',
...
var _user$project$Main$viewDigit = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$html$Html$div,
		{
		...
		{
			ctor: '::',
			_0: A2(_user$project$Main$viewDigitPart, 'd1', _p1._0),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Main$viewDigitPart, 'd2', _p1._1),
				_1: {
					ctor: '::',
					_0: A2(_user$project$Main$viewDigitPart, 'd3', _p1._2),
					_1: {
						ctor: '::',
						_0: A2(_user$project$Main$viewDigitPart, 'd4', _p1._3),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Main$viewDigitPart, 'd5', _p1._4),
							_1: {
								ctor: '::',
								_0: A2(_user$project$Main$viewDigitPart, 'd6', _p1._5),
								_1: {
									ctor: '::',
									_0: A2(_user$project$Main$viewDigitPart, 'd7', _p1._6),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Main$fromModelToDigitPair = F2(
	function (getNumber, model) {
		return _user$project$Clock$digitPair(
			getNumber(
				A2(
					_elm_community$elm_time$Time_DateTime$addMinutes,
					0 - model.timezoneOffset,
					_elm_community$elm_time$Time_DateTime$fromTimestamp(model.currentTime))));
	});
var _user$project$Main$colon = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('colon-dot'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('c1'),
					_1: {ctor: '[]'}
				}
			},
			{ctor: '[]'}),
		_1: {
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('c2'),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
...
var _user$project$Main$view = function (model) {
	var _p2 = A2(_user$project$Main$fromModelToDigitPair, _elm_community$elm_time$Time_DateTime$second, model);
	var s1 = _p2._0;
	var s2 = _p2._1;
	var _p3 = A2(_user$project$Main$fromModelToDigitPair, _elm_community$elm_time$Time_DateTime$minute, model);
	var m1 = _p3._0;
	var m2 = _p3._1;
	var _p4 = A2(_user$project$Main$fromModelToDigitPair, _elm_community$elm_time$Time_DateTime$hour, model);
	var h1 = _p4._0;
	var h2 = _p4._1;
	var children = {
		ctor: '::',
		_0: _user$project$Main$viewDigit(h1),
		_1: {
			ctor: '::',
			_0: _user$project$Main$viewDigit(h2),
			_1: {
				ctor: '::',
				_0: _user$project$Main$colon,
				_1: {
					ctor: '::',
					_0: _user$project$Main$viewDigit(m1),
					_1: {
						ctor: '::',
						_0: _user$project$Main$viewDigit(m2),
						_1: {
							ctor: '::',
							_0: _user$project$Main$colon,
							_1: {
								ctor: '::',
								_0: _user$project$Main$viewDigit(s1),
								_1: {
									ctor: '::',
									_0: _user$project$Main$viewDigit(s2),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {timezoneOffset: a, currentTime: b};
	});
var _user$project$Main$init = function (timezoneOffset) {
	return {
		ctor: '_Tuple2',
		_0: A2(_user$project$Main$Model, timezoneOffset, 0),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
...
var _user$project$Main$subscriptions = function (_p6) {
	return A2(_elm_lang$core$Time$every, 0.1 * _elm_lang$core$Time$second, _user$project$Main$Tick);
};
